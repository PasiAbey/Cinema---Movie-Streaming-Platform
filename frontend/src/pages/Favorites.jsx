...
export default function Favorites() {
  ...
  async function handleRemove(item) {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/user/favorites/${item.id}`, {
        method: 'DELETE',
        headers: {
      ...
      // Note: We don't need to manually update currentUser.profile here 
      // because AuthContext has a real-time listener on Firestore!
    } catch (e) {
      console.error(e);
    } finally {
      setRemoving(null);
